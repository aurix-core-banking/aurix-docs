...
### Create:
- `apps/frontend/aurix-admin/src/components/BulkApproveReject.js` — bulk approve/reject toolbar
- `apps/frontend/aurix-mobile/src/pages/onboarding/StepDocumentosPF.js` — PF document upload screen
- `apps/frontend/aurix-mobile/src/pages/onboarding/StepDocumentosPJ.js` — PJ document upload screen

### Modify:
- `apps/frontend/aurix-admin/src/pages/Dashboard.js` — add onboarding stat cards + funnel chart
- `apps/frontend/aurix-admin/src/pages/SolicitacoesConta/SolicitacaoContaList.js` — add bulkActionButtons
- `apps/frontend/aurix-admin/src/pages/SolicitacoesPJ/SolicitacaoPJList.js` — add bulkActionButtons
- `apps/frontend/aurix-mobile/src/services/onboardingService.js` — add `uploadDocumento` method
- `apps/frontend/aurix-mobile/src/navigation/AuthNavigator.js` — add `StepDocumentosPF`, `StepDocumentosPJ` routes
- `apps/frontend/aurix-mobile/src/pages/onboarding/FormPF.js` — navigate to StepDocumentosPF instead of SuccessScreen
- `apps/frontend/aurix-mobile/src/pages/onboarding/StepSocios.js` — navigate to StepDocumentosPJ instead of SuccessScreen
- `apps/frontend/aurix-mobile/package.json` — add `react-native-image-picker` dependency
...
**Files:**
- Modify: `apps/frontend/aurix-admin/src/pages/Dashboard.js:40-end`
...
```bash
git add apps/frontend/aurix-admin/src/pages/Dashboard.js
...
**Files:**
- Create: `apps/frontend/aurix-admin/src/components/BulkApproveReject.js`
- Modify: `apps/frontend/aurix-admin/src/pages/SolicitacoesConta/SolicitacaoContaList.js`
- Modify: `apps/frontend/aurix-admin/src/pages/SolicitacoesPJ/SolicitacaoPJList.js`
...
File `apps/frontend/aurix-admin/src/components/BulkApproveReject.js`:
...
```bash
git add apps/frontend/aurix-admin/src/components/BulkApproveReject.js apps/frontend/aurix-admin/src/pages/SolicitacoesConta/SolicitacaoContaList.js apps/frontend/aurix-admin/src/pages/SolicitacoesPJ/SolicitacaoPJList.js
...
**Files:**
- Modify: `apps/frontend/aurix-mobile/src/services/onboardingService.js`
- Modify: `apps/frontend/aurix-mobile/package.json`
...
```bash
git add apps/frontend/aurix-mobile/src/services/onboardingService.js apps/frontend/aurix-mobile/package.json
...
**Files:**
- Create: `apps/frontend/aurix-mobile/src/pages/onboarding/StepDocumentosPF.js`
- Modify: `apps/frontend/aurix-mobile/src/navigation/AuthNavigator.js`
- Modify: `apps/frontend/aurix-mobile/src/pages/onboarding/FormPF.js`
...
File `apps/frontend/aurix-mobile/src/pages/onboarding/StepDocumentosPF.js`:
...
```bash
git add apps/frontend/aurix-mobile/src/pages/onboarding/StepDocumentosPF.js apps/frontend/aurix-mobile/src/navigation/AuthNavigator.js apps/frontend/aurix-mobile/src/pages/onboarding/FormPF.js
...
**Files:**
- Create: `apps/frontend/aurix-mobile/src/pages/onboarding/StepDocumentosPJ.js`
- Modify: `apps/frontend/aurix-mobile/src/navigation/AuthNavigator.js`
- Modify: `apps/frontend/aurix-mobile/src/pages/onboarding/StepSocios.js`
...
File `apps/frontend/aurix-mobile/src/pages/onboarding/StepDocumentosPJ.js`:
...
```bash
git add apps/frontend/aurix-mobile/src/pages/onboarding/StepDocumentosPJ.js apps/frontend/aurix-mobile/src/navigation/AuthNavigator.js apps/frontend/aurix-mobile/src/pages/onboarding/StepSocios.js
