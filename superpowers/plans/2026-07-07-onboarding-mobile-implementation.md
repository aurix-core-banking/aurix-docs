...
- Base path for all file references: `apps/frontend/aurix-mobile/`
...
Run: `cd apps/frontend/aurix-mobile && npx jest --passWithNoTests`
Expected: `Tests: 0 total` (no test files yet, but no errors)

- [ ] **Step 7: Commit**

```bash
git add apps/frontend/aurix-mobile/package.json apps/frontend/aurix-mobile/babel.config.js apps/frontend/aurix-mobile/__mocks__/ apps/frontend/aurix-mobile/src/utils/validation.js
...
Run: `cd apps/frontend/aurix-mobile && npx jest src/__tests__/OnboardingService.test.js --no-cache`
...
```bash
git add apps/frontend/aurix-mobile/src/services/onboardingService.js apps/frontend/aurix-mobile/src/__tests__/OnboardingService.test.js
...
Run: `cd apps/frontend/aurix-mobile && npx jest src/__tests__/TipoSelector.test.js --no-cache`
...
```bash
git add apps/frontend/aurix-mobile/src/pages/onboarding/TipoSelector.js apps/frontend/aurix-mobile/src/__tests__/TipoSelector.test.js
...
Run: `cd apps/frontend/aurix-mobile && npx jest src/__tests__/FormPF.test.js --no-cache`
...
```bash
git add apps/frontend/aurix-mobile/src/pages/onboarding/FormPF.js apps/frontend/aurix-mobile/src/__tests__/FormPF.test.js
...
Run: `cd apps/frontend/aurix-mobile && npx jest src/__tests__/StepEmpresa.test.js --no-cache`
Expected: FAIL
...
```bash
git add apps/frontend/aurix-mobile/src/pages/onboarding/StepEmpresa.js apps/frontend/aurix-mobile/src/__tests__/StepEmpresa.test.js
...
Run: `cd apps/frontend/aurix-mobile && npx jest src/__tests__/StepSocios.test.js --no-cache`
Expected: FAIL
...
```bash
git add apps/frontend/aurix-mobile/src/pages/onboarding/StepSocios.js apps/frontend/aurix-mobile/src/__tests__/StepSocios.test.js
...
Run: `cd apps/frontend/aurix-mobile && npx jest --no-cache`
Expected: PASS (14 tests total)

- [ ] **Step 3: Commit**

```bash
git add apps/frontend/aurix-mobile/src/pages/onboarding/SuccessScreen.js
...
```bash
git add apps/frontend/aurix-mobile/src/pages/OnboardingScreen.js apps/frontend/aurix-mobile/src/navigation/AuthNavigator.js
