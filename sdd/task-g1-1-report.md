...
| File | Action |
|------|--------|
| `apps/backend/aurix-openfinance/src/main/java/.../client/CoreApiClient.java` | Modified — added 3 method signatures |
| `apps/backend/aurix-openfinance/src/main/java/.../client/CoreApiClientImpl.java` | Modified — added 3 stub implementations |
| `apps/backend/aurix-openfinance/src/main/java/.../service/OpenFinanceDataService.java` | Modified — added 2 new methods, imports |
| `apps/backend/aurix-openfinance/src/test/java/.../service/OpenFinanceDataServiceTest.java` | Created — 3 tests |
