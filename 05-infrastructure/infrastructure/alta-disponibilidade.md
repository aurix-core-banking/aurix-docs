...
- **Nginx**: configurado em `infrastructure/nginx/nginx.conf` com upstreams para gateway, core, pix, credit, treasury, security, compliance, analytics, audit, organization. Usado na pilha Docker Compose.
