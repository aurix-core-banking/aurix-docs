...
O que as áreas do banco (operações, compliance, risco, tesouraria, TI) precisam saber: relatórios, regulatório, auditoria, limites e processos.
...
- **Módulos de crédito**: documentados em [plataforma.md](../../01-business/big-picture.md) e [portal-desenvolvedor/apis/credito.md](../../03-development/portal-desenvolvedor/apis/credito.md).
- **Relatórios e limites**: conforme documentação de negócio e regulatório.

---

## Tesouraria

- **Módulo e liquidez**: referências em banco-dados e módulos backend (settlement, pricing).

---

## TI (APIs e integrações)
