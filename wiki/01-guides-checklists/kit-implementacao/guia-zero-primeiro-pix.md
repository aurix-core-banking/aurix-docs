...
3. **Primeira transferência**: seguir o guia [Primeiro PIX](../../03-development/portal-desenvolvedor/guias/primeiro-pix.md); enviar uma transferência de teste (valor mínimo) para uma chave de destino válida. Em homologação, usar ambiente simulado do BACEN se disponível.
...
2. **Checklist final**: revisar [checklist go-live](../checklists/go-live.md) (certificados, KYC, domínios, RegTech); confirmar que relatórios obrigatórios estão agendados.
