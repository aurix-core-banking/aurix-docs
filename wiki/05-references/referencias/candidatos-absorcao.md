# Documentos em docs/ – candidatos à absorção na wiki

Inventário de documentos fora da wiki que foram absorvidos ou permanecem como referência com link.

---

## Já absorvidos na wiki
...
## Mantidos como referência (wiki aponta para docs/)

| Documento | Uso na wiki |
|-----------|-------------|
| infrastructure/ (runbook, backup, DR, HA, deploy, monitoramento, etc.) | [sre-infra](../../04-audiences/por-audiencia/sre-infra.md), [manutencao](../../02-lifecycle/ciclo-de-vida/manutencao.md), [suporte](../../02-lifecycle/ciclo-de-vida/suporte.md), [referencias](README.md) |
| 03-compliance/regulatory-pack.md | [negocio](../../04-audiences/por-audiencia/negocio.md), [regulatorio](../../01-guides-checklists/checklists/regulatorio.md), [referencias](README.md) |
...
## Novos conteúdos na wiki

- **03-compliance/**: [README](../../03-compliance/conformidade/README.md), [spi-str-certificados.md](../../03-compliance/conformidade/spi-str-certificados.md)
- **01-guides-checklists/guias/**: [instalacao-admin.md](../../01-guides-checklists/guias/instalacao-admin.md)
- **02-lifecycle/ciclo-de-vida/run.md**: resumo do runbook (alertas, R1–R6)

[Voltar a Referências](README.md) | [Índice da wiki](../../README.md)
